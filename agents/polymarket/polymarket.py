...
class Polymarket:
    def __init__(self) -> None:
        ...
        self.polygon_rpc = "https://rpc.ankr.com/polygon"
        ...
        self.usdc_address = "0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"  # USDC.e
        self.native_usdc_address = "0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359"  # Native USDC
    ...
    def get_usdc_balance(self) -> float:
        ...
        usdce = float(usdce_balance / 10e5)

        # Check native USDC balance
        native_usdc = self.web3.eth.contract(
            address=self.native_usdc_address, abi=self.erc20_approve
        )
        native_balance = native_usdc.functions.balanceOf(address).call()
        native = float(native_balance / 10e5)

        if native > 0 and usdce == 0:
            print(f"WARNING: You have ${native:.2f} native USDC but $0 USDC.e")
